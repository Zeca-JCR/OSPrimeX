...
const TabBar = ({ onRequestClose }) => {
    ...
    // Verificar se existe handler de salvar para a aba pendente
    ...
    return (
        <>
            ...
            <UnsavedChangesModal
                ...
                onSaveAndClose={hasSaveHandler ? handleSaveAndClose : null}
