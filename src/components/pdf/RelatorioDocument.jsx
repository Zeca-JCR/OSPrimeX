...
export const RelatorioDocument = ({ tipo, dados, periodo, empresa }) => {
                ...
                return (
                    <>
                        ...
                        <Table
                            ...
                            data={Object.entries(dados.porDia).sort((a, b) => new Date(b[0].split('/').reverse().join('-')) - new Date(a[0].split('/').reverse().join('-')))}
                    ...
                    <>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
                            ...
                            <View style={styles.card}>
                                ...
                                <Text style={{ ...styles.cardValue, color: dados.saldo >= 0 ? 'blue' : 'red' }}>{formatCurrency(dados.saldo)}</Text>
                            </View>
                        </View>
                    ...
                    <>
                        ...
                        <Table
                            ...
                            renderRow={([status, qtd]) => {
                                const percent = dados.total > 0 ? (qtd / dados.total * 100).toFixed(1) : 0;
                                const statusLabels = {
                ...
                return (
                    <>
                        ...
                        <Table
                            ...
                            renderRow={(c) => [c.nome, c.qtd, formatCurrency(c.valor)]}
                        />
                    </>
                );
