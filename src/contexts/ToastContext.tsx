...
type ToastType = 'success' | 'error' | 'warning' | 'info' | 'save';
...
interface ToastContextType {
    ...
    showSaveToast: (message?: string) => number;
}
...
export const ToastProvider = ({ children }: ToastProviderProps) => {
    ...
    const showSaveToast = useCallback((message: string = 'Salvo com sucesso!'): number => {
